                ...
                <CardContent className="p-6 sm:p-8">
                  ...
                  {submitted ? (
                    ...
                    >
                      ...
                      <h3 className="text-lg font-semibold text-emerald-700">Message Sent!</h3>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <FadeInWhenVisible delay={0.1}>
            <Card className="overflow-hidden">
              <div className="relative bg-gradient-to-br from-emerald-100 via-emerald-50 to-muted flex items-center justify-center min-h-[300px] sm:min-h-[400px]">
                <div className="text-center space-y-4 p-8">
                  <div className="rounded-full bg-emerald-200/60 p-4 mx-auto w-fit">
                    <MapPin className="h-10 w-10 text-emerald-600" />
                  </div>
                  <h3 className="text-lg font-bold text-emerald-800">MEALICIOUS VENTURES PRIVATE LIMITED</h3>
                  <p className="text-emerald-600 text-sm max-w-sm mx-auto">
                    123 Health Street, Mumbai, Maharashtra 400001, India
                  </p>
                  <Separator className="max-w-xs mx-auto bg-emerald-200" />
