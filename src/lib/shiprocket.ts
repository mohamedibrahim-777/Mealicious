...
export async function createShiprocketOrder(params: CreateOrderParams) {
  const data = await sr('/orders/create/adhoc', {
    ...
    body: JSON.stringify({
      ...
      shipping_customer_name: params.billingName,
      shipping_last_name: '',
      shipping_address: params.billingAddress,
      shipping_address_2: '',
      shipping_city: params.billingCity,
      shipping_pincode: params.billingPincode,
      shipping_country: params.billingCountry || 'India',
